...
def process_pages(pages, query, output_file, use_ollama, use_cohere, use_gpt,
...
def process_file(file_path, query, output_file, use_ollama, use_cohere, use_gpt,
                 use_ollama_and_gpt, use_cohere_and_gpt, use_both, use_all):
    """
    ...
    try:
        ...
        page_summaries, final_summary = process_pages(pages, query, output_file, use_ollama, use_cohere, use_gpt,
                                                      use_ollama_and_gpt, use_cohere_and_gpt, use_both, use_all)
        # Save page summaries and final summary
        with open("page_summaries.txt", 'w', encoding='utf-8') as f:
            f.write("\n\n".join(page_summaries))
